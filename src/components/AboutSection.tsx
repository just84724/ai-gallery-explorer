...
const AboutSection = () => {
  return (
    <section id="about" className="py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gallery-gold/20 via-gallery-red/10 to-gallery-teal/20 -z-10"></div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow transform hover:-translate-y-1 duration-300">
            ...
            <h3 className="text-2xl font-bold mb-4 text-center">創意無限</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow transform hover:-translate-y-1 duration-300">
            <div className="bg-gradient-to-br from-gallery-teal to-gallery-pink w-16 h-16 rounded-full flex items-center justify-center mb-6 mx-auto">
              <Code className="text-white" size={28} />
            </div>
            <h3 className="text-2xl font-bold mb-4 text-center">技術創新</h3>
            <p className="text-gray-600 text-center">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow transform hover:-translate-y-1 duration-300">
            ...
            <h3 className="text-2xl font-bold mb-4 text-center">社群連結</h3>
            <p className="text-gray-600 text-center">
