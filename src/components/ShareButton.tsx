    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="absolute top-2 left-2 text-white hover:bg-white/30 backdrop-blur-sm bg-black/20 z-10"
        ...
        <div className="space-y-2">
          ...
          {socialPlatforms.map((platform) => (
            <Button
              ...
              variant="ghost"
              size="sm"
              className={`w-full justify-start gap-2 ${platform.className}`}
          ...
          <Button
            ...
            onClick={() => handleShare({ key: 'instagram', name: 'Instagram', className: '', icon: null, url: '' })}
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
